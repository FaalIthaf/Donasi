...
class LoginPanel extends JPanel {
    ...
    public LoginPanel(DashBoard app) {
        this.app = app;
        ...
        JLabel title = new JLabel("Selamat Datang - Masuk");
        ...
        add(new JLabel("Nama Pengguna:"), gbc);
        gbc.gridx = 1;
        userField = new JTextField(20);
        add(userField, gbc);

        gbc.gridy = 2; gbc.gridx = 0;
        add(new JLabel("Password (admin):"), gbc);
        gbc.gridx = 1;
        ...
        gbc.gridx = 1;
        roleBox = new JComboBox<>(new String[]{"donor", "admin"});
        add(roleBox, gbc);
        ...
        RoundedButton guestBtn = new RoundedButton(" Lihat Tanpa Login");
        guestBtn.setBackground(new Color(149, 165, 166));
        guestBtn.setForeground(Color.WHITE);
        guestBtn.addActionListener(e -> {
            // Show donor dashboard as guest with empty id
            app.login("", "donor");
        });
    ...
    private void performLogin() {
        ...
        if ("admin".equals(role)) {
            ...
            if ("admin".equals(user) && "admin123".equals(pass)) {
                ...
                JOptionPane.showMessageDialog(this, "Credential admin salah! Gunakan username 'admin' dan password 'admin123'.", "Login Gagal", JOptionPane.ERROR_MESSAGE);
            }
        } else {
            if (user.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Masukkan nama untuk login sebagai donatur.", "Validasi", JOptionPane.WARNING_MESSAGE);
                return;
            }
            app.login(user, "donor");
        }
    }
}
...
class UIConstants {
    ...
    public static final Color PANEL_BG = new Color(245, 246, 247);
...
public class DashBoard extends JFrame {
    ...
    public void logout() {
        // Reset current user and show login panel
        this.currentUserId = "";
...
class InputPanel extends JPanel {
    ...
    private JPanel createForm() {
        ...
        pesanArea.setFont(new Font("Segoe UI", Font.PLAIN, 14));
