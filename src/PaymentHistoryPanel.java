...
public class PaymentHistoryPanel extends JPanel {
    ...
    private JPanel createHeader() {
        ...
        kembaliBtn.setFont(new Font("Segoe UI", Font.PLAIN, 12));
        ...
        kembaliBtn.addActionListener(e -> app.showPanel("DonorDashboard"));
    ...
    private JPanel createContent() {
        ...
        tambahBtn.setFont(new Font("Segoe UI", Font.BOLD, 12));
