...
public class EditDonationDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        kategoriCombo.setFont(new Font("Times New Roman", Font.PLAIN, 13));
        ...
        bankCombo.setFont(new Font("Times New Roman", Font.PLAIN, 13));
        ...
        statusCombo.setFont(new Font("Times New Roman", Font.PLAIN, 13));
        ...
        pesanArea.setFont(new Font("Times New Roman", Font.PLAIN, 12));
        ...
        saveBtn.setFont(new Font("Times New Roman", Font.BOLD, 13));
        ...
        markPaidBtn.setFont(new Font("Times New Roman", Font.BOLD, 13));
    ...
    private JTextField createTextField() {
        ...
        field.setFont(new Font("Times New Roman", Font.PLAIN, 13));
