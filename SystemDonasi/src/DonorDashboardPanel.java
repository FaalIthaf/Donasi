...
public class DonorDashboardPanel extends JPanel {
    ...
    private JPanel createHeader() {
        ...
        JLabel title = new JLabel("Donatur");
        title.setFont(UIConstants.TITLE_FONT);
        title.setForeground(Color.WHITE);
        
        JLabel subtitle = new JLabel("“Sedikit dari Anda, harapan besar bagi mereka. Mari berdonasi dan jadi bagian dari perubahan.”\r\n" + //
                        "");
    ...
    private JPanel createStatCard(String title, String value, Color color) {
        ...
        valueLabel.setFont(new Font("Times New Roman", Font.BOLD, 28));
    ...
    private JPanel createMenuButtons() {
        ...
        donateBtn.setFont(new Font("Times New Roman", Font.BOLD, 16));
        ...
        historyBtn.setFont(new Font("Times New Roman", Font.BOLD, 16));
