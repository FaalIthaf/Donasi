...
public class AdminDashboardPanel extends JPanel {
    ...
    private JPanel createHeader() {
        ...
        header.setBackground(new Color(31, 58, 95));
        ...
        JLabel subtitle = new JLabel("Kelola data donasi dengan bijak");
    ...
    private JPanel createContent() {
        ...
        gbc.gridx = 1;
        content.add(createStatCard("Total Donatur", "0", new Color(0,0,0)), gbc);
    ...
    private JPanel createStatCard(String title, String value, Color color) {
        ...
        titleLabel.setFont(new Font("Times New Roman", Font.PLAIN, 15));
        ...
        valueLabel.setFont(new Font("Times New Roman", Font.BOLD, 32));
    ...
    private JPanel createMenuButtons() {
        ...
        menuPanel.add(createMenuButton("Laporan", new Color(52, 152, 219), "Laporan"));
